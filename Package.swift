...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.1.0-rc.5.xcframework.zip",
			checksum: "7d3f7c1350b63a7818e708f35dca026fdf00e2cd6378f9cc74e33d7ad2239433"
		)
	]
)