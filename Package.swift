...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.39.xcframework.zip",
			checksum: "197836f5f87ca27baf208a5a86684a21bf4d8fe9a2db87a181f8761e948d7611"
		)
	]
)