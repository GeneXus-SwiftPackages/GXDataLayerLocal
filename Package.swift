...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.25.xcframework.zip",
			checksum: "e559a63b5d8905fa8381edddae57ba628991d4a5232928fa24b7e85ef97d8cd8"
		)
	]
)