...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.13.xcframework.zip",
			checksum: "c18bb50588244611ddf220498b1ff37b2fdbb0f8a62c50efbfaeea6f68cad4ca"
		)
	]
)