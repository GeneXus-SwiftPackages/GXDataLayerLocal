...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-4.0.0-rc.43.xcframework.zip",
			checksum: "15fa82b489c58a395b0af9e74813e79e57b545b468b10b7f0f2f2a2d0d0b7c10"
		)
	]
)