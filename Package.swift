...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-3.0.0-rc.2.xcframework.zip",
			checksum: "abf36c6ac08c44a45e92c43ea4e8ed5b9f5c2348bd7df8d7076db68782349f5c"
		)
	]
)