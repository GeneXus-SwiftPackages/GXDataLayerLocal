...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-2.0.0-rc.22.xcframework.zip",
			checksum: "1873b4b10149d852db1a5a48ab285611d261c61989febd385c5794360c5a09ba"
		)
	]
)