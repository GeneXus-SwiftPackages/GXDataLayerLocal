...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.4.0-beta.19.xcframework.zip",
			checksum: "4e8672239be865ef74979290cf7f223ea26820257f13bd865eec30e96fd7f1b0"
		)
	]
)