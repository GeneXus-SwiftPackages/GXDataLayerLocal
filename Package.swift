...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.13.xcframework.zip",
			checksum: "96620e97d8631f5e0ecda6c73605dfd99f0bb9f6eb925afd462f840efe4b55dc"
		)
	]
)