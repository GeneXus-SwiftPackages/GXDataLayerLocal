...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.25.xcframework.zip",
			checksum: "e4e2d88e5d6638bb69536ac316752900153a0867b6f4e654bafba94a0825e0ed"
		)
	]
)