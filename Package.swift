...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.3.0-beta.9.xcframework.zip",
			checksum: "9b98e6e2fe825a603b7c21a925e5045e35606f53a3958b9f996c4bbf150a66be"
		)
	]
)