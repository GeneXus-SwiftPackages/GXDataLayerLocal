...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.1.5.xcframework.zip",
			checksum: "b25780b8faea44e7705aa0c22a8a62b553df6a71c79cec077d803aef99c661d6"
		)
	]
)