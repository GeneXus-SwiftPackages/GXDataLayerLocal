...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.23.xcframework.zip",
			checksum: "5bcebd3db487cee8beb837992f6137c3ee7905e6ca8e872306f59d820a0d20dc"
		)
	]
)