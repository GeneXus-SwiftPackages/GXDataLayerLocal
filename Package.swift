...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.15.xcframework.zip",
			checksum: "7b31011609161cea4e0385d5b0eea9c7d1176985006c13eb6185244b31765305"
		)
	]
)