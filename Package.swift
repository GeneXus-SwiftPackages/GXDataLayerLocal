...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.22.xcframework.zip",
			checksum: "bfb8ba58a358e317471c3b03df20d0f6f74035e3cfc79890851317bb3e7174e8"
		)
	]
)