...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.9.xcframework.zip",
			checksum: "f786ff0ffd1a9b0a446ccce0f2a7112fde2ac1b4e7abd400011380e4e939a29a"
		)
	]
)