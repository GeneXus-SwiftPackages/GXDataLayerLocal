...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-3.0.1.xcframework.zip",
			checksum: "935fbf35f0b0e0fc1b6dc85af8e3d255e1eb0d3c2912108d61524896c175f496"
		)
	]
)