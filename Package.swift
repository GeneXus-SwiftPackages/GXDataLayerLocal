...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.3.0-rc.1.xcframework.zip",
			checksum: "87740f08befa90082892976c1c38fa654bf81c4f57eb69c35d022b3cb8b3087d"
		)
	]
)