...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.10.xcframework.zip",
			checksum: "15c5932cef666c7fd669dd2dadd92a684dde00c6087a636dc270d3425298d10c"
		)
	]
)