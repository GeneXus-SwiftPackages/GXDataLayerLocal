...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.32.xcframework.zip",
			checksum: "b16b17f9a83ae0ca2789e2719a01024281f82e50fbf350ebbd6a3e24e1d911b6"
		)
	]
)