...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.5.17.xcframework.zip",
			checksum: "dc9013eeffb11f6fc4ee0549bd813254b3e83d5a676727ac953746f612e35af2"
		)
	]
)