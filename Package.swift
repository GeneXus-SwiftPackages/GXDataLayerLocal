...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230509112137.xcframework.zip",
			checksum: "9cccdf01bbb7a628cddee6a4a7451df2be5e121eaffd274ef06a66dbcddd9996"
		)
	]
)