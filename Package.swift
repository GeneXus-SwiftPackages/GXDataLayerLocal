...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.19.xcframework.zip",
			checksum: "bdf6d33c80b861b3cbfcfe8849323a1100e7a45c5164af8860dfc6b1e17f1db8"
		)
	]
)