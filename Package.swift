...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-2.0.18.xcframework.zip",
			checksum: "7646a44607b2e0813c7e31847b5e9d4e2cbf47fd9c602788555784bcafda4163"
		)
	]
)