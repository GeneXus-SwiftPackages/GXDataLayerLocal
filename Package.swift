...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.1.0-beta.9.xcframework.zip",
			checksum: "4dd380bff8216f0c2906b3f39b5347f26a39bcd2814e9ecfb636ddcb482d28d7"
		)
	]
)