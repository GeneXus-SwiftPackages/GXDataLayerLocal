...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.27.xcframework.zip",
			checksum: "7bcecf5cf304026c5195a61c5d1e3675c5b39de940dbfa3a31c1185278ac6b33"
		)
	]
)