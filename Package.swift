...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-3.0.0-rc.8.xcframework.zip",
			checksum: "20b67fdf8173784f909253776cbc55f183803afec5c2703f3d16464eac50ee97"
		)
	]
)