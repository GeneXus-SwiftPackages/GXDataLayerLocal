...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-3.2.0-rc.11.xcframework.zip",
			checksum: "a1b91397973316cf2059975df078df30ef6e0f130f27b3227fcb42c63e070644"
		)
	]
)