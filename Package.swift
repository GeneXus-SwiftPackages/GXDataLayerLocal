...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.18.xcframework.zip",
			checksum: "d1fdc74bf57434e098d58e585112b32d924bc8079c1a5686ddea341756b27763"
		)
	]
)