...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.31.xcframework.zip",
			checksum: "72e99cee0ac79b230b0ffb8988e3ffba9e778d8af8d41b6371ccf6c98b00f409"
		)
	]
)