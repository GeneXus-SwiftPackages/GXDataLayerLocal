...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.1.0-beta.24.xcframework.zip",
			checksum: "c2ecead6c72e402cc3bca57395d0cd25eefb182bba6ca5c7545685eed2eabcaf"
		)
	]
)