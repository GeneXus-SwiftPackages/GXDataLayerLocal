...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.1.0-rc.4.xcframework.zip",
			checksum: "5bb68df8926201f4e8dcf3f9e9c59f438b285d059eb3419bd6906c2f9a9cf642"
		)
	]
)