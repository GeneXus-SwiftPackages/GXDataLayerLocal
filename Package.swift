...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.8.xcframework.zip",
			checksum: "4756b70a4b9a648d0c7a21f9f447698043acfd81aff62dc44fb13265b103bf55"
		)
	]
)