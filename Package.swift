...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.29.xcframework.zip",
			checksum: "c19d9a0015633d878d69c1067fd49abf8c9745e406400f0b6a60611f0deabe3a"
		)
	]
)