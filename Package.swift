...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.1.0-beta.13.xcframework.zip",
			checksum: "1a064fa275719a7a852f8facb9f654fb188e773739e48fdee324cfb79cb514e6"
		)
	]
)