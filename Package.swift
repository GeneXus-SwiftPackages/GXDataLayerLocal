...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-4.1.0-rc.25.xcframework.zip",
			checksum: "9a68359fa6618f5353dbbcc9aaee57d03c546e34b7fda2e25ac7ef0367037d53"
		)
	]
)