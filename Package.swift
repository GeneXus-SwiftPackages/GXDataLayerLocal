...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.1.0-beta.11.xcframework.zip",
			checksum: "19ca4743587cea68afa4c656ebf88d72cf2efea2895e76d078a82ba72982f839"
		)
	]
)