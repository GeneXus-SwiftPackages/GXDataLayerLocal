...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.7.xcframework.zip",
			checksum: "2413d8df00f434e5b96a4fa7cfe57e3f62b493a212574a22a3d466ad1a59d945"
		)
	]
)