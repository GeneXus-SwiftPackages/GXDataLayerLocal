...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.23.xcframework.zip",
			checksum: "b398bb904719124314c04fd8c1bcafefde8adb2f4cdc2e1a532b600a45ef9f34"
		)
	]
)