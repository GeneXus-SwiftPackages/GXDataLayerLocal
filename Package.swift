...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.6.xcframework.zip",
			checksum: "f04f6e2cca76a34f06763d7b392bdb94e57011462fafe02ecc9daa6d428a51b4"
		)
	]
)