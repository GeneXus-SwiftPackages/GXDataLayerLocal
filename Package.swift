...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.9.xcframework.zip",
			checksum: "3f1e4fc8cd86915ffa6ef7e617b6ad1683a63c7c9f64ae2d2970a056a815c0c6"
		)
	]
)