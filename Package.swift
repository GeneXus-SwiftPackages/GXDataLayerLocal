...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.10.xcframework.zip",
			checksum: "8cc6abde1ba5455bd4aac874f469d591443379c33923b62fb9b1941b147c362d"
		)
	]
)