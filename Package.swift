...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.11.xcframework.zip",
			checksum: "8bf87a81f06a4b971ac1849458ce94be2b4151d9096076ecdf895907ea06d8bc"
		)
	]
)