...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.17.xcframework.zip",
			checksum: "9d78a5e4851705c1ab2f1effe06bcb7b56854c882c5090cf52a12d25dafc65a5"
		)
	]
)