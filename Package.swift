...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.3.0-beta.5.xcframework.zip",
			checksum: "2c4a830927d6fd5f962ddd882f21c4e9412e4b027019a1bf4dfb314e418f0b09"
		)
	]
)