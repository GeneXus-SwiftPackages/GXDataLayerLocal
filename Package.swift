...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.10.xcframework.zip",
			checksum: "0ad2d34ba7fcde19e34fe97ad55913f877ecd0aef499493914969c990a1d023c"
		)
	]
)