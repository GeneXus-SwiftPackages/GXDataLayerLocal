...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.12.xcframework.zip",
			checksum: "bd201820a529db724b5ec5fdbf0da3658f75b49ac5bb9eeb9e3e450e7dafe77e"
		)
	]
)