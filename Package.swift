...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.8.xcframework.zip",
			checksum: "8be5d49feebc79d3c23ae440b45e33a5465115d89c633733e03d00bd5a4ccf05"
		)
	]
)