...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.3.0-beta.7.xcframework.zip",
			checksum: "73bfa4e457559b5845486047cab6e56c0f0cb2edac275a049d9470504473c16e"
		)
	]
)