...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230306155445.xcframework.zip",
			checksum: "8632c568d3edbdaeee1c86acfbd03d3e556f663532fae11a9146c99b6ec8f1af"
		)
	]
)