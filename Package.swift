...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.24.xcframework.zip",
			checksum: "293831724fe8cb793105295a93edd3b05b835fbc9713a416b5b8436f362f228a"
		)
	]
)