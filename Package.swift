...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.5.0-rc.28.xcframework.zip",
			checksum: "d93f9d697ac70f5921a3a0135116f73b7c89b71ebcd84a450eeceeabe8642a5f"
		)
	]
)