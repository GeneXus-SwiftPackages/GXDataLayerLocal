...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.9.xcframework.zip",
			checksum: "48d679fb39d4f097375d4f5824edf707245dba99de48c68c4de8a94ff4ecf56b"
		)
	]
)