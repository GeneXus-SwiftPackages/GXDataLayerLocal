...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.29.xcframework.zip",
			checksum: "a7ee0ed527cf4f3ded82a84da8e04a2872498f946176d7c8c7b027dc7e89461a"
		)
	]
)