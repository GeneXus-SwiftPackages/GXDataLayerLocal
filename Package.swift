...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.0.0.xcframework.zip",
			checksum: "e46448744c9d57ba6c279f063e461cb67b907e13eed62382792457161c19f1a3"
		)
	]
)