...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.24.xcframework.zip",
			checksum: "7fd2cfc6ae96be58a23b1540f300d948594ff641166c48d2fd20f694132a13c9"
		)
	]
)