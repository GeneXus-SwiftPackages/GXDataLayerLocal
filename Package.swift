...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.27.xcframework.zip",
			checksum: "119d843a26b34d90a72f50e130ec9a40255ed7a6f966b88090459644f5f70d66"
		)
	]
)