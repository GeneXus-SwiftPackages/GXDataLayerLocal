...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.1.0.xcframework.zip",
			checksum: "52c6c55fb3920c1cd81119672546d3e8ac3d384b3dc74a14f6bd6da2819433f4"
		)
	]
)