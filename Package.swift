...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.2.1.xcframework.zip",
			checksum: "f596bb5981cc6713ab3a5d51cd51483ae45cb345fbec9d05a8f6ed55f117a88a"
		)
	]
)