...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.4.xcframework.zip",
			checksum: "933b36cb9869f24804d972d3eb48aa8864aafa20390ecb408e951d34b68db24a"
		)
	]
)