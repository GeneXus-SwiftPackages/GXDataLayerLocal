...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.3.0-rc.7.xcframework.zip",
			checksum: "e23a11ad9b32206ea7a8d3b19052358e5dd9986486e1f1167a6e97b58202610f"
		)
	]
)