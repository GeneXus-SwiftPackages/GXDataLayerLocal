...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.28.xcframework.zip",
			checksum: "927a610ad34f898115b5949b3ee8981813535f38457a3b16d50fa6ca35a655e2"
		)
	]
)