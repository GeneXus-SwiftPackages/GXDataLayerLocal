...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.16.xcframework.zip",
			checksum: "7c0b4f2f2f329c70de0953de17381f728b6494ae01938fc17a848c5639527428"
		)
	]
)