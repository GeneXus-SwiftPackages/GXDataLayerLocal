...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.1.3.xcframework.zip",
			checksum: "4433cbe80a47795ffbd625fc3aecb6a777eefac53ca4450474d4e3e22bebe6b4"
		)
	]
)