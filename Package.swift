...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.2.xcframework.zip",
			checksum: "d2e01b36c56a1d85d3020052ed89d0e31874a5a56d38a59a342ad29436b3b61f"
		)
	]
)