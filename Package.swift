...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.0.0-beta.45.xcframework.zip",
			checksum: "49fdd45a8695ee968e949c3e7c2616df0710496c50b673cccb230842dcd76ad1"
		)
	]
)