...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.8.xcframework.zip",
			checksum: "f7f8e43e121ad45d24c200477cf4f750394a64c164717dd8a844cffba359ba36"
		)
	]
)