...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.3.xcframework.zip",
			checksum: "d1a70db7cb47ccc2498079802fb5c00a4e368ec8c624b32890731483870b7da2"
		)
	]
)