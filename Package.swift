...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.7.xcframework.zip",
			checksum: "70a0fcdaf32fbf16d67ff440ad91d004cb4c4463654f9222fddc4cbbacb85f9b"
		)
	]
)