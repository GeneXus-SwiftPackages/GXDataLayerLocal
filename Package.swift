...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-4.0.0-rc.0.xcframework.zip",
			checksum: "8293131eedd30185a0694b5defa89ce9ef0884fe8d97e6d27ebf3596f17298d1"
		)
	]
)