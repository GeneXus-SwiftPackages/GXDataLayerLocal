...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.3.5.xcframework.zip",
			checksum: "0295a39ee6e5c890ba1d26c8e293c0df5de34a8869d62b89082df6e1bc04f4ce"
		)
	]
)