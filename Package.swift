...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-5.0.0-rc.1.xcframework.zip",
			checksum: "6883541968b36d757115e26a5617a5989fd7f89b10a38cc02f58923276b4120e"
		)
	]
)