...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-2.0.0-rc.32.xcframework.zip",
			checksum: "de40999c6cd38d6d6c89252aa7def9223bb697d46d23f28526f8d69a2d702eee"
		)
	]
)