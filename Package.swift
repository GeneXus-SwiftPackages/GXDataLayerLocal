...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.4.0-beta.16.xcframework.zip",
			checksum: "bd39482b22f7e556c09b860ccdf3e98f60b6d4f64edf2a6911a122faeee90968"
		)
	]
)