...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.4.0-rc.5.xcframework.zip",
			checksum: "0ec85be5e83e9b1847ba3d4e03b4dac5af12a3c3f6ad9c073a9b3be68b1bf398"
		)
	]
)