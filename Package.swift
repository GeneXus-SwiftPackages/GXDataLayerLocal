...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-2.0.17.xcframework.zip",
			checksum: "c3fe80c41b9412b31f21fd20194c077e804479d2011a7edb00723c610887d6e1"
		)
	]
)