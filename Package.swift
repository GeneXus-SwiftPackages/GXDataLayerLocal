...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-3.1.4.xcframework.zip",
			checksum: "fb0627b1c93e4111ee4af91e822bafdc1fa3d741ca810ae3fd56b966222949dc"
		)
	]
)