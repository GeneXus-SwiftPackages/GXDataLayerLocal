...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.2.0-rc.15.xcframework.zip",
			checksum: "f7d6fd5950e930279b38f9608f3bf31d12eebcd395fa78f5946c5f2ae47a7b56"
		)
	]
)