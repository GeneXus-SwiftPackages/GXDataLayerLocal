...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.0.5.xcframework.zip",
			checksum: "80d71cc71aab50e01fdc6f8969b18d72bf630e1400dfdd8bc4e71923966f2d54"
		)
	]
)