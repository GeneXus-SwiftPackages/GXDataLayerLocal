...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.4.0-beta.18.xcframework.zip",
			checksum: "95b056bf2fc5c07b2508a4ff4475f319cc6b5ede7b90f85646d4a1bf5a970abd"
		)
	]
)