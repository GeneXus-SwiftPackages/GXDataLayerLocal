...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.2.0-rc.25.xcframework.zip",
			checksum: "45825c56e395cd65763e0c6ac785ff70214eb9d7574802af3f879cd2b53128ed"
		)
	]
)