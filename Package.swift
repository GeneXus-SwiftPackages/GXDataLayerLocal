...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.33.xcframework.zip",
			checksum: "ef63f60cedec594139365eeddcb734268c1cea6f3ccb406e35525f512530a8a0"
		)
	]
)