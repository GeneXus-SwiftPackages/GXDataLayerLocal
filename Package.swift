...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.15.xcframework.zip",
			checksum: "1423a8ae6798345a97c729ea764f84f972a3aa12f7010c39a1630b73d45f0e5a"
		)
	]
)