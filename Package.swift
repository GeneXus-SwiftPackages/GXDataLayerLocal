...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.3.0-beta.10.xcframework.zip",
			checksum: "33283fe37d0968e0214024f685b06a8ea9f5d1663c3c001929d4f8678a652254"
		)
	]
)