...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.2.xcframework.zip",
			checksum: "970ffe94f2e5f75033108152089acdf51ce20fb9fb6049feddf6e0120cd98efc"
		)
	]
)