...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.31.xcframework.zip",
			checksum: "cbbc9d20d8e5cddc42da924fa4fa268174e6efd611e2ba7c1170bc61d87d7f62"
		)
	]
)