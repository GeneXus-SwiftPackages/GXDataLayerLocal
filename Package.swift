...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-2.0.0-rc.36.xcframework.zip",
			checksum: "2bf70e1fceece7946a21c0bde9669b1498763de030a9185c2144d3ad7e29f4e7"
		)
	]
)