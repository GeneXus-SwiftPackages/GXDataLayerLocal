...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-2.2.0-rc.1.xcframework.zip",
			checksum: "38d489a5c33589d49cac80b222984679cff43adb40e222f8a87bc8cc0e47fe85"
		)
	]
)