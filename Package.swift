...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.1.0-beta.26.xcframework.zip",
			checksum: "51565ce2352e92a0aea2160e44f3eb0606b59b78c740b00a594d2080b51c5c08"
		)
	]
)