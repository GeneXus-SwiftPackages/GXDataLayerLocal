...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-3.1.0.xcframework.zip",
			checksum: "638424ae37c698614f4ee84c7dd2276ed6477d96be7f86f063b7bc6113ef209f"
		)
	]
)