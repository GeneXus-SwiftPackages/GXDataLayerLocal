...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.2.xcframework.zip",
			checksum: "19b5188b6c1010857d141cbb4739e740e8822faa53a411cf99386493218f6ce1"
		)
	]
)