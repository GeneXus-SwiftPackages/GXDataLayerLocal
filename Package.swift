...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.1.0-beta.5.xcframework.zip",
			checksum: "3473769a042dbf33f27304feb403fa5b4af001b07bce62d48f3dca79e481e680"
		)
	]
)