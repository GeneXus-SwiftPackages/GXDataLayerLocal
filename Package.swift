...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.11.xcframework.zip",
			checksum: "80861ec9d9aa51b36eec8f8acb740ce3968e2a548b21fe97fc0c8ee0fa51edba"
		)
	]
)