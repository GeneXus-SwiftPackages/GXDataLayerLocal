...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.13.xcframework.zip",
			checksum: "da770dbccb4f9e2c80d573ba8cb5f10e6ee9eb578104a3f24007064d94068dd3"
		)
	]
)