...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.12.xcframework.zip",
			checksum: "c8a6161f512c8c07ee16db62715b1f95ef5642dd7e6f60efe0fe222f0430097f"
		)
	]
)