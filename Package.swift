...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.6.xcframework.zip",
			checksum: "3e1a48aa38080d2bae102a73a03aef3b7d97f188742b532c12aae15f0638cafc"
		)
	]
)