...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta.20230627202653.xcframework.zip",
			checksum: "4e3854eed5aaa08d6a76a16a45648b323e302fa9dec2500bb29e40ce6277d50a"
		)
	]
)