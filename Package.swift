...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.10.xcframework.zip",
			checksum: "47b0a8fdd9bf91b5fd6eddd82484140586f2977a7a759bea0177738fffc8f1d5"
		)
	]
)