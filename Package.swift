...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.1.1.xcframework.zip",
			checksum: "38731a7f67e3500d088eff88e63218976752040c046069f007a1ab445e854d3c"
		)
	]
)