...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.1.2.xcframework.zip",
			checksum: "ecb7e88052f1584821e01f62531c113e23d1ebeeb71f2e5aed74d81a05a80430"
		)
	]
)