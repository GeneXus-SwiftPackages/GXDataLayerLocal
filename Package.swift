...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-3.0.4.xcframework.zip",
			checksum: "c588c757b8fb6ac48feb81ee087d7e456230b24b76ead840e9ee07cabbadcfbf"
		)
	]
)