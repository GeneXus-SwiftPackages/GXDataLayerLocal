...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.34.xcframework.zip",
			checksum: "2887c8973d8c3d13532b00ab9c7587415b282dd48b65671fb345710dbdcc6a40"
		)
	]
)