...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.25.xcframework.zip",
			checksum: "32ab6100e8aae5bc07471c6e99612132339b51f1762772fba816c6979709d431"
		)
	]
)