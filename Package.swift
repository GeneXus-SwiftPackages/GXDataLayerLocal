...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-3.2.0-rc.9.xcframework.zip",
			checksum: "070be40b2c69046a2624fcf708180053bb23804b856c0cb7bcaa38004a496f82"
		)
	]
)