...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.22.xcframework.zip",
			checksum: "d0ac2bf63014e801a309486ef9fa8c4c9243258b23b5b559c6f501b156a00826"
		)
	]
)