...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230323132058.xcframework.zip",
			checksum: "f7728995fc1887a8e9196967425b2a3c923810448ff2eaeff46f6dabcc745819"
		)
	]
)