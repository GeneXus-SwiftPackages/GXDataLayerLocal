...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.30.xcframework.zip",
			checksum: "da3e0e4fea883412cc5bb4f10d081fb86dd613057967096644c86bce2423bf85"
		)
	]
)