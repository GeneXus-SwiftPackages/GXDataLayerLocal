...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-5.0.0-beta.6.xcframework.zip",
			checksum: "ea1048d6d99feee7fefc66025af2024c12906a890535a1585ee9ab67820f6f3e"
		)
	]
)