...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.17.xcframework.zip",
			checksum: "fcd5395a73f76530f82397f9df384f6317d9379222fce86edc341f52aa2a0b04"
		)
	]
)