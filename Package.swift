...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.4.0-beta.8.xcframework.zip",
			checksum: "5421926e72fddc33839784bcb91b3dfb484c298387158494137955b44b17b925"
		)
	]
)