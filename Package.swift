...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.6.0-beta.1.xcframework.zip",
			checksum: "99c5cd9e45ee510082360b758ac85cf24dcf78cef42747ce579c5f3353fbf195"
		)
	]
)