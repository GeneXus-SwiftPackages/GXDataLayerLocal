...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230217195542.xcframework.zip",
			checksum: "fcd5f13fe4d2092764649296fe602b0fa512037a10de4658d85e6b65c764a8d0"
		)
	]
)