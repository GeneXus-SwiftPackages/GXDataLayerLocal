...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.30.xcframework.zip",
			checksum: "352217e05d8ccc3aa793b886ca032a9f5cf917832794efafb1e300f5a50b6d95"
		)
	]
)