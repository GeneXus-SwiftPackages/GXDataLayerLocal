...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.4.27.xcframework.zip",
			checksum: "cc940fae7333dbfc6fb78a50abbe475ff66778f10a9bb529bd03792763aa1129"
		)
	]
)