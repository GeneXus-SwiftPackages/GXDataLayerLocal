...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230606172938.xcframework.zip",
			checksum: "34ac96cbf3dd8951fb78a4d7a5ea28e3b40ee1e965acba2f9d9603bab313ab94"
		)
	]
)