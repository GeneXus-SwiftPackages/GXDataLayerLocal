...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.3.0-rc.13.xcframework.zip",
			checksum: "4c15ed617778f20ce39a2e12ff6b1174a4ed09ccebe8e815d4712adeec46c137"
		)
	]
)