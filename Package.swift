...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "c5f917cd29e88a1906edddef9adbb19752c3740bbc3d4676f7f25a51dcd3535a"
		)
	]
)