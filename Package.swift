...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-5.0.0-beta.4.xcframework.zip",
			checksum: "4d7abba315373f600ee9ee1b3074857125811f9739d8efb2acac34fcb3ac4e6c"
		)
	]
)