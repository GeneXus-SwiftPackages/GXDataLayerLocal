...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.4.31.xcframework.zip",
			checksum: "67330a97294cc9821e65474f33914c9139ff424d2fbce2cb569aca66a2f5f992"
		)
	]
)