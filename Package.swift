...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-5.0.0-rc.0.xcframework.zip",
			checksum: "2667791091a88d92a83b66ee156220c1ae71df07331f4ad9260514838237c1f7"
		)
	]
)