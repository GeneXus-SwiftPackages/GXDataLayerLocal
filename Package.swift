...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.31.xcframework.zip",
			checksum: "875c8ec27288cf1ff8a19041690dc2a70a83908167eade017ef2a7e92eeed592"
		)
	]
)