...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.30.xcframework.zip",
			checksum: "e5eb6e92fd2dbd7430dcfed965f0f55836c329b23493e0ec859c05087586950e"
		)
	]
)