...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.27.xcframework.zip",
			checksum: "498a15fd406410c7a0d5c650b3fd8978757849f556dd5fbf3a37b0795c91fd64"
		)
	]
)