...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.31.xcframework.zip",
			checksum: "fc759ebd897002c5ac2f0ff091f8f0082718c726a54e8931df55ce0fd54ea60c"
		)
	]
)