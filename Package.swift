...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.5.0-rc.26.xcframework.zip",
			checksum: "6e535e9f5edbb7560db8e722a3338d278e49f7ca8b0f95a3869f0d00887058b6"
		)
	]
)