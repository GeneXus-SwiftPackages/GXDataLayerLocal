...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.3.0-beta.8.xcframework.zip",
			checksum: "27f0acf1a2447f76616be386fab77cda125e4600be92c0394ba519ee754fad9e"
		)
	]
)