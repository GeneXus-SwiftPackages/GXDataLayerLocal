...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.2.0.xcframework.zip",
			checksum: "5f3ff8a0263e038d68284ae46a84b724dbfa1b69113ac22294eb03a3733a178d"
		)
	]
)