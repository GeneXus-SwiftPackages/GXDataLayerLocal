...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.0.0-beta.44.xcframework.zip",
			checksum: "cc8ce1db939da918a9603ac1224c1e9274810af2eea489f2bf6d74254b95845b"
		)
	]
)