...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-2.1.3.xcframework.zip",
			checksum: "52eff29b767af2cf9c0850a9d5a81f76daf33c9b5a01bc3a03c1dc734abd92bf"
		)
	]
)