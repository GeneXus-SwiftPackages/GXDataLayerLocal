...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.0.16.xcframework.zip",
			checksum: "2804bd4d390e16b0d44c3749aca7dcfb229f3ed31629cd5db7d4f112b939a8dc"
		)
	]
)