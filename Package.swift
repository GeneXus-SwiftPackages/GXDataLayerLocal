...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-3.2.0-rc.12.xcframework.zip",
			checksum: "488ba58fd72c894d35e10030f8ea8cbac8466f898c21afec4ff7fcaa7ee13bc2"
		)
	]
)