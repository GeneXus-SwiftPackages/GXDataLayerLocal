...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.11.xcframework.zip",
			checksum: "b425a406db4fbb54baae520595c39b4e430c1d6869452f21c941af6abe5f3fb4"
		)
	]
)