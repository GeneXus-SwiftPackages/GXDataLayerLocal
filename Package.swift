...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.35.xcframework.zip",
			checksum: "c9c5263ac2b71427ffdc13f6ec200ba060ca8fb0d75e1bf7ac0759c7f9f5a49e"
		)
	]
)