...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-5.0.0-beta.1.xcframework.zip",
			checksum: "596005a44e7f157d11bee8bcceb6ea7ac068d177b5655a4c1826bba92c5b7419"
		)
	]
)