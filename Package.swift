...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.14.xcframework.zip",
			checksum: "e4b08fdc00bfb3a21167b2a6cb826539cc563f418c5f3c8b0a55ddc6355ce5e7"
		)
	]
)