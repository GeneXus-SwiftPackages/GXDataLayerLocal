...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.0.xcframework.zip",
			checksum: "60ba0128a2a439316dc6d3ac3b7ec59500b47408045f0f1ecf8e98f1f489156c"
		)
	]
)