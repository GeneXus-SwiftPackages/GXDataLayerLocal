...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-4.2.0-rc.37.xcframework.zip",
			checksum: "b5b2ea5e6f23563b8f26a342cdd56f0b24cdf36036443af6fc3c505c99e5955e"
		)
	]
)