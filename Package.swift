...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.1.0-rc.1.xcframework.zip",
			checksum: "76147bf47fe91d9f9535304f5a8360ff5dacd98f1c084cf0ef0f6413d1d0db92"
		)
	]
)