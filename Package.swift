...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.2.2.xcframework.zip",
			checksum: "060b4576f7c495376e93846b77ece0a34c12ed56187b04b5ba8946874c2b2b34"
		)
	]
)