...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.19.xcframework.zip",
			checksum: "d46f9c8c084fdd3ecb5658abb56589e936d41ae3a2a4953699b471118747e09e"
		)
	]
)