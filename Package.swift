...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.4.0-rc.1.xcframework.zip",
			checksum: "700765fc813d6f42f50cb3199b6cc3b89337247b6f11cfea69bae36626d23fd2"
		)
	]
)