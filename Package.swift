...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.1.0-beta.8.xcframework.zip",
			checksum: "03a105b13772d4a8ccbefe3ff90f5558badfa861c8f42d40fda0fc882fee3153"
		)
	]
)