...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230411173940.xcframework.zip",
			checksum: "b21706d95dd858e5f495da4a02618cfc1cf6096ab55f098413b3c33da1a0edd3"
		)
	]
)