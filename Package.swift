...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-3.1.5.xcframework.zip",
			checksum: "a609ce6311cd364871c778023d456b4b2ab3d0142aef7ce21c241a1ea859e101"
		)
	]
)