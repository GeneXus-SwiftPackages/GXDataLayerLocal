...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.40.xcframework.zip",
			checksum: "c6149f7c3aacb0f9221dd54a3a3e5b61d9c5511df19610d8056fdbd135fbf5d4"
		)
	]
)