...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-3.1.0-rc.3.xcframework.zip",
			checksum: "9524c0efb02f0420b2e8e66617799684e4451c6cc183d5a1debea816c714ff49"
		)
	]
)