...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.12.xcframework.zip",
			checksum: "f27e09be38a1c1570e9771ff81cd54fc5e5b63fa145224eaa15187d30654f7a4"
		)
	]
)