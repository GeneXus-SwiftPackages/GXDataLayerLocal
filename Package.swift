...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.6.0-beta.4.xcframework.zip",
			checksum: "1b04399ce6c2b225dd2559485bf4eb06bfcc97e2fc7e61a89ea90a25614029f2"
		)
	]
)