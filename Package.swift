...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.40.xcframework.zip",
			checksum: "d61046ea0914cceaf47d7340a0145aad8efae9811387e825ec3f2ab36376e2eb"
		)
	]
)