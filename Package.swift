...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.4.xcframework.zip",
			checksum: "0039233d93856bdc5a06515cef10da9396929ce536f5d43a1009b56fb9ccb91a"
		)
	]
)