...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.14.xcframework.zip",
			checksum: "a163cc0ca43776ec12f8b626b8efac0a4b620ced7fef6cd1ff62634e7cd916bf"
		)
	]
)