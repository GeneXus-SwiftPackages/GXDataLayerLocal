...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.18.xcframework.zip",
			checksum: "7b45fc279ce150c58590801c55d9a533b30c34b2c3512198669b01ff673f048e"
		)
	]
)