...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-4.2.0-rc.20.xcframework.zip",
			checksum: "2534c2f5b427a6ae86b43f43fe5dc95eadb2bded18057287a5d1d74b48976b6f"
		)
	]
)