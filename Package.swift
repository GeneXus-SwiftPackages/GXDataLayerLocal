...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.11.xcframework.zip",
			checksum: "d6089ac673b16c1d8f7060fe0c0ba225f38def5d59b7ad39f3461979f9d414a1"
		)
	]
)