...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-2.1.4.xcframework.zip",
			checksum: "ea76719c47762dd550c06ad306f2426d2aa9d22d93645b4c4a04e2cd6ebfce00"
		)
	]
)