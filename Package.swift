...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.4.0-beta.11.xcframework.zip",
			checksum: "2451c63e5cded2bd87bd8531de1c6c23209724cbe37016e5cb20e7cde90ae21a"
		)
	]
)