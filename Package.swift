...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.29.xcframework.zip",
			checksum: "b97686ada507b6f867e6e6be7a937ff95dd163ed40283622d85e179c652afd83"
		)
	]
)