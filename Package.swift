...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.14.xcframework.zip",
			checksum: "b6f53ebd6f7449e869e060d89a054e213b1883e4fb91b9731c897bbf178a3c7c"
		)
	]
)