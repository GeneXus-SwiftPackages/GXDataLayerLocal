...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.2.0-rc.1.xcframework.zip",
			checksum: "0fbda0f8a814e83616cf1bc92fc6044247315edebd48ad0c64848bf36fbb4f00"
		)
	]
)