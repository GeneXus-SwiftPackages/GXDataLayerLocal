...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta.20230704132152.xcframework.zip",
			checksum: "0ebdfce3dcfad1fc24b0e542ff8290b490b02ce630e2ccb3a87a6a16ebdc91e0"
		)
	]
)