...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.1.xcframework.zip",
			checksum: "e78d56f62d9ae54c3b1d5a422caf8f05c05a179538400657dfc2a7ba46e910fb"
		)
	]
)