...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.11.xcframework.zip",
			checksum: "73bd5a6a9de667bda54f1ce365dd9006f3ba535ccefe2f367aad6a9d82609991"
		)
	]
)