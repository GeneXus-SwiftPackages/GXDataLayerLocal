...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-2.1.0.xcframework.zip",
			checksum: "37bdebaa81ff381f5e0c1db9261e5ea781b48dc339345bd955dac3bd79907068"
		)
	]
)