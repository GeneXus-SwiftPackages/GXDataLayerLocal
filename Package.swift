...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.34.xcframework.zip",
			checksum: "49dbfcc7d1453fecc7baf20c84eb774e42668f44df7bf7718be436f09e3ed066"
		)
	]
)