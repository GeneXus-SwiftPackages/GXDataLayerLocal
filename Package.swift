...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.13.xcframework.zip",
			checksum: "afc6d0fd4fbd6f637b3497dc7b6d3bd4a685de4c8de1c3b2e3f3099a51a5e03d"
		)
	]
)