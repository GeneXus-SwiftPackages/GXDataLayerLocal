...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-4.1.0-rc.14.xcframework.zip",
			checksum: "16ae3972ae379c3b086ef701b6fef8f9aa9209733332c8b0b0502a872d32f508"
		)
	]
)