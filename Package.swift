...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.9.xcframework.zip",
			checksum: "cb470a6b3d218c94915190ee45c465053703aa125220db16fc1cc130a0166bbe"
		)
	]
)