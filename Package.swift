...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.1.2.xcframework.zip",
			checksum: "7a249efdc9c6575d8b616a02f9daaa224c7ef7d67cb34e9077d9196e5a528c50"
		)
	]
)