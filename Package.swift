...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.25.xcframework.zip",
			checksum: "e801aaf2aa3588a75ba4311de1992c86eec456c99cbce18e41d610fbd35ccbb4"
		)
	]
)