...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.38.xcframework.zip",
			checksum: "8f10022abf51622b5df92fd93692128ded33105e8589c4212ce98432a162963f"
		)
	]
)