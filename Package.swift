...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.25.xcframework.zip",
			checksum: "96895aee59ae3f0c0ce68aa7d6248317c085eaa7c80648ab20d1dc360d33fc4d"
		)
	]
)