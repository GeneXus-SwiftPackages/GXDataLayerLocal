...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.38.xcframework.zip",
			checksum: "1076190f3d3fead5bb8f503661fff257374cc6a8bfc8251e18a29e0bcd5275fa"
		)
	]
)