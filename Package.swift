...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.11.xcframework.zip",
			checksum: "d2944f755fa8f7eb44452afe71c41b005ef93e357da97a28ad44ab306f5b50d5"
		)
	]
)