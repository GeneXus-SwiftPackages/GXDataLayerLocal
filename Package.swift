...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.16.xcframework.zip",
			checksum: "b4aeb7d75f652039bbd0efc8a4c7d7276da882a1259604563c27a52989be017d"
		)
	]
)