...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.19.xcframework.zip",
			checksum: "3590ace7dd45987e543fdcceddab97a8413f6264efd898a523f1a01e3f1726b3"
		)
	]
)