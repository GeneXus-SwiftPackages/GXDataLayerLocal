...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.19.xcframework.zip",
			checksum: "b67c63fd6597c1eed7afb5859dd50a06b8e131a6f340efcef2558c45ef79eb6e"
		)
	]
)