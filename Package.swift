...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.23.xcframework.zip",
			checksum: "ec7fc11a0d76cec186a5228a1db230bce4c2bf64b3b5516292d34e976e7b6e4b"
		)
	]
)