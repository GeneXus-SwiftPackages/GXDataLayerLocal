...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230525122919.xcframework.zip",
			checksum: "c0433615fcbcdf2b238572b6bccbbcede1cec881a0d9beeb4e0c42db0d2a804b"
		)
	]
)