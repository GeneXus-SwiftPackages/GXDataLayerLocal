...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-3.1.0-rc.8.xcframework.zip",
			checksum: "ca523eb42f30d5ecd7f8f65d804d5d724fcc2a3bad393f4ca50f49ae0bf148c0"
		)
	]
)