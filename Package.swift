...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.3.6.xcframework.zip",
			checksum: "ade91c8cbd68da5e0883b9ed71b51e337ec0740a51ca40aee178f4a6bdda2f0c"
		)
	]
)