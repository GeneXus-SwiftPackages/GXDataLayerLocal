...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-2.0.0-rc.34.xcframework.zip",
			checksum: "97e6770a1448b2d06dc9b3fe86f7892907ad366d5e855f0b4fda4b823b468f3c"
		)
	]
)