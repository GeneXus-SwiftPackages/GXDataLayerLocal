...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230309142042.xcframework.zip",
			checksum: "76302fade2756ea5df9cb8af0ce3cff97eb92bef9befbb3f2b0230b685432b3a"
		)
	]
)