...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.17.xcframework.zip",
			checksum: "57be9c2b5c8c0fc298aa7ad8a9e8beeb7594e07f6ecf226eff86d28fe24b9a1f"
		)
	]
)