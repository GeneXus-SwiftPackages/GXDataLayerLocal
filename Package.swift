...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.1.0-beta.5.xcframework.zip",
			checksum: "7d41b95f83e93211f1d98e88f4e216ffdc24ae3d6df581f7d8fdbefa9cf97f88"
		)
	]
)