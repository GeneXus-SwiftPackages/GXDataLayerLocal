...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.0.0-beta.17.xcframework.zip",
			checksum: "4f9735c25686f31702d506b4ce63e399d8486f1ceb4ce715d7f1014d29280b0f"
		)
	]
)