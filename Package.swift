...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.41.xcframework.zip",
			checksum: "6bf634394f8a1f9719a1282a4ae4f08de60b08c63beb893a0e93dcb7badfbe12"
		)
	]
)