...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.5.xcframework.zip",
			checksum: "37e657addbb88ab59504f1ca7b7f54165c732100c62e34f395c6e69dc1a74b06"
		)
	]
)