...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.1.0-beta.7.xcframework.zip",
			checksum: "519bcc1177bca36dad889f7fcb8eea9884580b22d036bda3e948bf05dde3bd11"
		)
	]
)