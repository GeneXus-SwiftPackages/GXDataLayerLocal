...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.19.xcframework.zip",
			checksum: "282031ce0b706ef6423e15d7067e3aa772151ab52f93da368989b73d1c97232b"
		)
	]
)