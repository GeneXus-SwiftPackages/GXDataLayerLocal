...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.5.0-rc.2.xcframework.zip",
			checksum: "0c46e0d00bb5db492bd6bf23c94ba2ab60f8e9f12648313c5d0a65a8135551f8"
		)
	]
)