...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.4.0-beta.6.xcframework.zip",
			checksum: "91f554ca941d3789750f2c831a5b74d289d48123c0e8015786c764c7f94fdc4d"
		)
	]
)