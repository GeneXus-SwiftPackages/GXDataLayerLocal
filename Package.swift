...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.20.xcframework.zip",
			checksum: "2524971ff7cfaf35a874a79ab1882c006370519fcb444a3bb08594a73dc4e9d3"
		)
	]
)