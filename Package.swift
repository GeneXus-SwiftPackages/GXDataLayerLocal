...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.26.xcframework.zip",
			checksum: "a3f688267dd4d5174073e648c11c416c0a2623cbc5763ef05be126bd3a3e40a3"
		)
	]
)