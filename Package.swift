...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.20.xcframework.zip",
			checksum: "6c4b8c00b405ffc9cbbe4424061592f5787775e0afe96c8038115c7ac54cd827"
		)
	]
)