...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.1.0-beta.794.xcframework.zip",
			checksum: "f8e2a673668e13932ec2393ae84ca2d318444f29a2fe513cb6093c3642ca10b8"
		)
	]
)