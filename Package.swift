...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.14.xcframework.zip",
			checksum: "0dfa2edc3f0fe45fe490c187929088fed7865b375aa5663ffcc9e531162703d5"
		)
	]
)