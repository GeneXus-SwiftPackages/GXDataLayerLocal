...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.0.6.xcframework.zip",
			checksum: "3974a853dcf500a192f20d7e80a629443fbf66cf82fc8b484b63a0693caa6163"
		)
	]
)