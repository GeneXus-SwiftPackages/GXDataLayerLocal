...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-3.0.0-rc.15.xcframework.zip",
			checksum: "7892c9179e8715bdaafd67d85bf4239075771dab9b663e0afd20581c7f09a803"
		)
	]
)