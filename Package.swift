...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.3.0-beta.6.xcframework.zip",
			checksum: "42f60304838ef74414765b47bd884999f623ddf03f0b06c6d6d42efa85178fea"
		)
	]
)