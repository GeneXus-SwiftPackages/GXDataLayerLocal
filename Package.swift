...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.0.0-beta.47.xcframework.zip",
			checksum: "258f8b45e83dcae7a541c65a635d998ed6efb28a8c4a7442ba7371c05d567113"
		)
	]
)