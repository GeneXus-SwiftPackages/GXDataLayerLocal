...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.3.0-beta.4.xcframework.zip",
			checksum: "365afa1ff418f73b1e6626bfd65d2280583f72d1c12802d40358ac5f07465f21"
		)
	]
)