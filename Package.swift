...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.4.30.xcframework.zip",
			checksum: "93f95cda790a0a7317ff4fb37fb4b593e0f7e3eac78edbaf357fd9083c3282d9"
		)
	]
)