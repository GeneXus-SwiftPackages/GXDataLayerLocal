...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-4.0.9.xcframework.zip",
			checksum: "5b9757d18baa88493de298e6627dc2dae399bf44a43d0581e104e31bba636e02"
		)
	]
)