...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.4.0-beta.3.xcframework.zip",
			checksum: "41299a9f7012e1600028a0a3cd28c441c87ed379e77c2e0fa76f848b5b548601"
		)
	]
)