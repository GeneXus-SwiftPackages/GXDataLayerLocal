...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.4.xcframework.zip",
			checksum: "35d3a050155a5740653f051e59f8ed23382f38ae0e257ca2ecf0d777e05e67bc"
		)
	]
)