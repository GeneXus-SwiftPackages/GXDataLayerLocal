...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.2.0-beta.16.xcframework.zip",
			checksum: "7e4041bed14b425b7ded04a00c0c7dfab32fbb7bd3838d5a078616f487ed8154"
		)
	]
)