...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.21.xcframework.zip",
			checksum: "4662a718bed8bb4022eb8472ecfcfecd546108631e4202a83f35d71e75747a49"
		)
	]
)