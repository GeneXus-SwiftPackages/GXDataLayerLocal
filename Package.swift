...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerLocal-1.5.16.xcframework.zip",
			checksum: "0357732681c5d58897173f7b5645da5b99775b8ac16522dde805c4a308ec45aa"
		)
	]
)