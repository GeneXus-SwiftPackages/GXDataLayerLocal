...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.37.xcframework.zip",
			checksum: "163f99f509b6318f2154e4d32487e548465db69c9954739371f286fc8b27c8c6"
		)
	]
)