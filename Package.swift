...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.24.xcframework.zip",
			checksum: "0be924e49cf3bc8863944a2d10e18791aee242e53fb9cb7e7fbfadabf7972999"
		)
	]
)