...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.3.xcframework.zip",
			checksum: "ff53bc174430acea2d8d50bb616f05b4683551f26a6935ff858a5efedd8889b1"
		)
	]
)