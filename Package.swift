...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230519182256.xcframework.zip",
			checksum: "f4d6496d7aba66d01f6d80d803f38644a791b05a75a17f51bf1bcbb992b82d6f"
		)
	]
)