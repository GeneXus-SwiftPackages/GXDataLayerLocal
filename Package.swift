...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.25.xcframework.zip",
			checksum: "17296916753fb27a4d5d3001beb5396f1a75661306f98381a4105f6ea2b2bcd0"
		)
	]
)