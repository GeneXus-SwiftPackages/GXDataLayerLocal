...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.0.0-beta+20230515020747.xcframework.zip",
			checksum: "273d3a6acb0d710120cad9c4a71c5f0dee7a8e8af9828fa42ce1a471d1d8d2d4"
		)
	]
)