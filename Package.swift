...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.36.xcframework.zip",
			checksum: "25225eceecd93aea4c3f0acbb0dd164f472956a4aa94e8f32222ac0750f6f36c"
		)
	]
)