...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-4.2.0-rc.34.xcframework.zip",
			checksum: "50812c382dc5a434a24eff4cbe0eb36f44bc9b776f5482713530ebfcfe0c0a8a"
		)
	]
)