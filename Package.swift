...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.12.xcframework.zip",
			checksum: "c7ce1873eff0e8cf982406a18124d0de8ec09befbf08c828ca33f38400d02789"
		)
	]
)