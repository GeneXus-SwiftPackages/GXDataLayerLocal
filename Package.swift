...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.18.xcframework.zip",
			checksum: "763862879cb2aa357932e53bbae20dfa18da3b2be11db28353314c569a70fbcf"
		)
	]
)