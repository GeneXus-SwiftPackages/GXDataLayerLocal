...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.0.0-beta.24.xcframework.zip",
			checksum: "9a845748a533ef16a1da29c65f7e22999384c6edbfaa405d96535ce937075bc8"
		)
	]
)