...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.0.0-preview.20230715000002.xcframework.zip",
			checksum: "6b3ab359c23ddbcf21f250ccb042e50df714a18756268dd07418bd73154e1f4e"
		)
	]
)