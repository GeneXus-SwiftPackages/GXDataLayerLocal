...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.17.xcframework.zip",
			checksum: "be86dda8e7e853dd8bb2599baa3a3402741bfe72c7215be8e346e5cc81719d31"
		)
	]
)