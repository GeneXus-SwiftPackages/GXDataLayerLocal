...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.15.xcframework.zip",
			checksum: "cc905021963d86178309595505f25b96aa3c4fe8901067ce07c3a3eb859a9be6"
		)
	]
)