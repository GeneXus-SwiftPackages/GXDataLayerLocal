...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.3.xcframework.zip",
			checksum: "4b1b09a82a3372cb5e1d6fddcdbe32a6b63a410c3ec75c8ce566743d1dd4aea6"
		)
	]
)