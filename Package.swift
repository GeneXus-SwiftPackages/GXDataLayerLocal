...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-1.6.0-rc.0.xcframework.zip",
			checksum: "16966cdfbe0eaea5187885b0cb74d70a7fcf32729b0773da0634eca772ad10a8"
		)
	]
)