...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.36.xcframework.zip",
			checksum: "ecb4074df6e3ab25538b98c860e4d0d07b817c0dfcaf006b6af07b94e1c149b0"
		)
	]
)