...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-2.2.0-beta.10.xcframework.zip",
			checksum: "fa5e52c9d2ad8ef00a4f48b927eb4d9b6f6fc88a719684b60a8ae0ea4be1ed4d"
		)
	]
)