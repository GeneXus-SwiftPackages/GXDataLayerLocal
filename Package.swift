...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.1.0-beta.12.xcframework.zip",
			checksum: "469ae5b3ff00ee2cde712e8a5fd15ffc326142c6196e6971391c0c78b265fa2e"
		)
	]
)