...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerLocal-2.1.0-rc.23.xcframework.zip",
			checksum: "3423e9d62a139422389c92ce4315dd2d78a46168c8ebcd4ceb453cf554b36501"
		)
	]
)