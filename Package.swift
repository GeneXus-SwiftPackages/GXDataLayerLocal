...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-1.5.0-beta.28.xcframework.zip",
			checksum: "bc595d0bf85c04426b929e2894a4d3ad659259de64dad78121d5edf3c64adb7b"
		)
	]
)