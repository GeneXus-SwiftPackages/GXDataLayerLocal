...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.0.0-beta.48.xcframework.zip",
			checksum: "52b6fb5008d0c6526ea77c5aa90f3daafbdd3775634d909c88f551affe6ee511"
		)
	]
)