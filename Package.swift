...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-3.2.0-beta.21.xcframework.zip",
			checksum: "4f4bbff84195ed10aad2b8f82649b984db9d2ec4dc97fd7bebe290a5c2faf235"
		)
	]
)