...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerLocal",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerLocal-4.2.0-beta.7.xcframework.zip",
			checksum: "432af72babc06f647a24f3e33e85b33e57e756dfe569589338906181dfa89fc4"
		)
	]
)